...
open class XmlPsiReferenceContributor : PsiReferenceContributor() {
    ...
    override fun registerReferenceProviders(registrar: PsiReferenceRegistrar) {
        registrar.registerReferenceProvider(ID_PATTERN, ID_REFERENCE_CONTRIBUTOR, 1000.0)
        registrar.registerReferenceProvider(ENTITY_PATTERN, ENTITY_REFERENCE_CONTRIBUTOR, 1000.0)
        registrar.registerReferenceProvider(FOREIGN_KEY_PATTERN, FOREIGN_KEY_REFERENCE_CONTRIBUTOR, 1000.0)
    }
        ...
        override fun getReferencesByElement(element: PsiElement, context: ProcessingContext): Array<PsiReference> {
            ...
            if (element is XmlAttribute) {
                ...
                val xmlFiles = cacheManager.getFilesWithWord(
                    ...
                    .filter { it.rootTag != null && it.rootTag!!.subTags != null }
...
//                val usages1 = xmlFiles.stream()
//                    .flatMap { it.rootTag?.subTags.stream() }
//                    .filter { id == it.getAttributeValue(entityWithId) }
//                    .toList()
//                return arrayOf(XmlReference(element, usages1))
            }
            return arrayOf(XmlReference(element, usages))
        }
    }

    private class ForeignKeyPsiReferenceProvider : PsiReferenceProvider() {
        ...
        override fun getReferencesByElement(element: PsiElement, context: ProcessingContext): Array<PsiReference> {
            ...
            if (element is XmlAttribute) {
                ...
                val xmlFiles = cacheManager.getFilesWithWord(
                    ...
                    .filterIsInstance<XmlFile>()
                    .filter { it.rootTag != null && it.rootTag!!.name == "dataset" && it.rootTag!!.subTags != null }
